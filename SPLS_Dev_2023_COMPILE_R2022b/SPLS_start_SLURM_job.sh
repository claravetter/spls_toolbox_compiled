...
echo '*** SPLS           X CORE            ***
echo '****************************************
echo 'export LD_LIBRARY_PATH=/data/core-psy-pronia/opt/matlab/v913/runtime/glnxa64:/data/core-psy-pronia/opt/matlab/v913/bin/glnxa64:/data/core-psy-pronia/opt/matlab/v913/sys/os/glnxa64:/data/core-psy-pronia/opt/matlab/v913/sys/opengl/lib/glnxa64
...
cd $SPLS
./SPLS_Dev_2023_COMPILE_R2022b/for_testing/SPLS_Dev_2023_COMPILE_R2022b $datafile
EOF
chmod u+x $SLURMFile
datum=`date +"%Y%m%d"`
